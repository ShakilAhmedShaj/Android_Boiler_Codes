package com.shajt3ch.sqlitecrud;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (delete > 0) {
                    Toast.makeText(MainActivity.this, "Successfully Deleted row", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "Row Delete Failed", Toast.LENGTH_SHORT).show();
                }
